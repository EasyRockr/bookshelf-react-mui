...
import { normalizeDoc, searchBySubject } from '../../lib/olClient.js'
...
export default function Random() {
  ...
  const surprise = () => {
    ...
    searchBySubject(subject, 12, { ttlMs: 2 * 60 * 1000, signal: abortRef.current.signal })
      .then(docs => {
        const list = (docs || []).map(normalizeDoc)
        setRows(list)
